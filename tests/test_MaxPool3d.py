...
class TestMaxPool3d(object):
    ...
    def get_tensors(self, in_channels, depth, kernel_size_depth, kernel_size_hex, stride_depth, stride_hex):
            channel_dist = 1000
            depth_dist = 40
            ...
            pooled_array = np.expand_dims(np.stack([channel * channel_dist +
                                                    np.stack([(dstep * stride_depth + kernel_size_depth - 1) *
                                                              depth_dist + pool2d_array
