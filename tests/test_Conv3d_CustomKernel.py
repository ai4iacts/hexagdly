...
class TestConv3d(object):
    ...
    def get_tensors(self, in_channels, depth, kernel_size_depth, kernel_size_hex, stride_depth, stride_hex, bias_bool):
        channel_dist = 1000
        depth_dist = 40
        ...
        if kernel_size_hex==1:
            kernel = [np.ones((1,in_channels,kernel_size_depth,3,1)),
                      np.ones((1,in_channels,kernel_size_depth,2,2))]
        elif kernel_size_hex==2:
            kernel = [np.ones((1,in_channels,kernel_size_depth,5,1)),
